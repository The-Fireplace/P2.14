    ...
    update()
    {
        ...
        if (!this.player.getData("isDead"))
        {
            ...
            if (this.canUseControls())
            {
                ...
                if (this.keyW.isDown || this.keyUp.isDown || this.keyNum8.isDown || this.throttle.dragged && (this.pointer2.y < this.throttle.y))
                {
                    this.canMove('y');
                    ...
                    this.player.moveUp();
                } else if (this.keyS.isDown || this.keyDown.isDown || this.keyNum5.isDown || this.throttle.dragged && (this.pointer2.y > this.throttle.y))
                {
                    this.canMove('y');
                ...
                if (this.keyA.isDown || this.keyLeft.isDown || this.keyNum4.isDown || this.steering.dragged && (this.pointer1.x < this.steering.x))
                {
                    this.canMove('x');
                ...
                } else if (this.keyD.isDown || this.keyRight.isDown || this.keyNum6.isDown || this.steering.dragged && (this.pointer1.x > this.steering.x))
                {
                    this.canMove('x');
